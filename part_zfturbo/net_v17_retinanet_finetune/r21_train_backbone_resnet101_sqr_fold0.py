...
def create_generators(args, preprocess_image):
    ...
    from net_v17_retinanet_finetune.a01_csv_generator import CSVGeneratorCustom
    if 1:
...
if __name__ == '__main__':
    ...
    root_path = ROOT_PATH
    models_path = MODELS_PATH + 'retinanet_resnet101_sqr_removed_rads/'
    if not os.path.isdir(models_path):
        os.mkdir(models_path)
    params = [
        # '--snapshot', models_path + 'resnet50_fold_0_226_0.5380.h5',
        # '--imagenet-weights',
        '--weights', MODELS_PATH + 'retinanet_resnet101_sqr/resnet101_fold_{}_0.3573_26.h5'.format(fold),
        # '--weights', MODELS_PATH + 'retinanet_resnet101_sqr_removed_rads/resnet101_fold_{}_0.1503_05.h5'.format(fold),
        '--gpu', str(gpu_id),
        '--steps', '560',
        '--epochs', '1000',
        ...
        '--image-max-side', '1024',
        'csv',
        root_path + 'modified_data/retinanet_train_sqr_data_removed_rads/fold_{}_train.csv'.format(fold),
        root_path + 'modified_data/retinanet_train_sqr_data_removed_rads/classes.txt',
        '--val-annotations', root_path + 'modified_data/retinanet_train_sqr_data_removed_rads/fold_{}_valid.csv'.format(fold),
    ]
    main(params)
...
Fold 0:
Initial: mAP: 0.1378
Ep 1: 109s 390ms/step - loss: 1.7226 - regression_loss: 1.2886 - classification_loss: 0.4340 mAP: 0.1423
Ep 2: 49s 173ms/step - loss: 1.7027 - regression_loss: 1.2669 - classification_loss: 0.4358 mAP: 0.1354
Ep 5: 50s 179ms/step - loss: 1.6716 - regression_loss: 1.2514 - classification_loss: 0.4202 mAP: 0.1503
Unfreeze backbone
Ep 1: 319s 570ms/step - loss: 1.6589 - regression_loss: 1.1955 - classification_loss: 0.4635 mAP: 0.1656
Ep 2: 192s 342ms/step - loss: 1.6334 - regression_loss: 1.1919 - classification_loss: 0.4416 mAP: 0.1823
Ep 3: 188s 335ms/step - loss: 1.6530 - regression_loss: 1.2051 - classification_loss: 0.4479 mAP: 0.1690
Ep 4: 187s 334ms/step - loss: 1.5838 - regression_loss: 1.1561 - classification_loss: 0.4277 mAP: 0.1564
Ep 5: 185s 330ms/step - loss: 1.5572 - regression_loss: 1.1496 - classification_loss: 0.4076 mAP: 0.1817
Ep 7: 186s 332ms/step - loss: 1.5444 - regression_loss: 1.1323 - classification_loss: 0.4121 mAP: 0.1711
Ep 10:185s 330ms/step - loss: 1.5211 - regression_loss: 1.1516 - classification_loss: 0.3695 mAP: 0.1630
Ep 12:184s 329ms/step - loss: 1.5037 - regression_loss: 1.1113 - classification_loss: 0.3924 mAP: 0.1630
Ep 28:185s 330ms/step - loss: 1.3021 - regression_loss: 0.9730 - classification_loss: 0.3291 mAP: 0.1553
Ep 29:184s 329ms/step - loss: 1.3240 - regression_loss: 0.9555 - classification_loss: 0.3685 mAP: 0.1363
'''
