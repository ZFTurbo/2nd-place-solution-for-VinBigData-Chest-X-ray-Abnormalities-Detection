...
if __name__ == '__main__':
    ...
    params = [
        # '--imagenet-weights',
        '--weights', MODELS_PATH + 'retinanet_resnet101_sqr/best/resnet101_fold_{}_0.3804_24.h5'.format(fold),
        # '--weights', MODELS_PATH + 'retinanet_resnet101_sqr_removed_rads/resnet101_fold_{}_0.1626_12.h5'.format(fold),
        '--gpu', str(gpu_id),
        '--steps', '560',
        '--epochs', '1000',
...
'''
Fold 2:
Ep 6: 116s 207ms/step - loss: 1.7386 - regression_loss: 1.2307 - classification_loss: 0.5079 mAP: 0.1620
Ep 13:111s 197ms/step - loss: 1.7354 - regression_loss: 1.2560 - classification_loss: 0.4794 mAP: 0.1961
Unfreeze
Ep 3: 192s 343ms/step - loss: 1.6342 - regression_loss: 1.1840 - classification_loss: 0.4502 mAP: 0.1938
