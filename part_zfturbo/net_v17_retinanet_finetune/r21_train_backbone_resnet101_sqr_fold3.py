...
if __name__ == '__main__':
    ...
    params = [
        # '--imagenet-weights',
        '--weights', MODELS_PATH + 'retinanet_resnet101_sqr/resnet101_fold_{}_0.3584_24.h5'.format(fold),
        # '--weights', MODELS_PATH + 'retinanet_resnet101_sqr_removed_rads/resnet101_fold_{}_0.1548_10.h5'.format(fold),
        '--gpu', str(gpu_id),
        '--steps', '560',
        '--epochs', '1000',
...
'''
Fold 3:
Ep 7: 114s 203ms/step - loss: 1.6652 - regression_loss: 1.2325 - classification_loss: 0.4327 mAP: 0.1438
Ep 13:116s 206ms/step - loss: 1.6632 - regression_loss: 1.2047 - classification_loss: 0.4585 mAP: 0.1511
Unfreeze
Ep 3: 192s 342ms/step - loss: 1.5784 - regression_loss: 1.1846 - classification_loss: 0.3930 mAP: 0.1645
Ep 7: 189s 337ms/step - loss: 1.5800 - regression_loss: 1.1136 - classification_loss: 0.4665 mAP: 0.1884
'''
