...
if __name__ == '__main__':
    ...
    model_list = [
        MODELS_PATH + 'retinanet_resnet101_sqr/resnet101_fold_0_0.3573_26.h5',
        MODELS_PATH + 'retinanet_resnet101_sqr/resnet101_fold_1_0.3481_35.h5',
        MODELS_PATH + 'retinanet_resnet101_sqr/resnet101_fold_2_0.3804_24.h5',
        MODELS_PATH + 'retinanet_resnet101_sqr/resnet101_fold_3_0.3584_24.h5',
        MODELS_PATH + 'retinanet_resnet101_sqr/resnet101_fold_4_0.3514_12.h5',
    ]
    for m in model_list:
        params = [
            m,
