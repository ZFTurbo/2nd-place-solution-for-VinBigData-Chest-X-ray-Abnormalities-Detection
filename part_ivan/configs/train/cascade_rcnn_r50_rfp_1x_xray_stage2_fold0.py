...
data = dict(
    ...
    train=dict(
        img_prefix='data',
        classes=classes,
        ann_file='data/folds/coco_train_fold_0_stage2.json',
        pipeline = train_pipeline,
        filter_empty_gt=False),
    val=dict(
        img_prefix='data',
        classes=classes,
        ann_file='data/folds/coco_valid_fold_0_stage2.json',
...
load_from = 'weights/cascade_r50_augs_with_empty/fold0.pth'
work_dir = 'work_dirs/cascade_r50_augs_rare_with_empty_fold0'
