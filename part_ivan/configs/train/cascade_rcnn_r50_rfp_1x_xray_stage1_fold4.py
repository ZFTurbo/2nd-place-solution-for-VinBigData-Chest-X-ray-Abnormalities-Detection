...
data = dict(
    ...
    train=dict(
        img_prefix='data',
        classes=classes,
        ann_file='data/folds/coco_train_fold_4_stage1.json',
        pipeline = train_pipeline,
        filter_empty_gt=False),
    val=dict(
        img_prefix='data',
        classes=classes,
        ann_file='data/folds/coco_valid_fold_4_stage1.json',
...
work_dir = 'work_dirs/cascade_r50_augs_with_empty_fold4'
